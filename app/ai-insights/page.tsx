    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="min-h-screen">
        ...
        <main className="p-5 lg:p-8">
          <div className="mb-6">
            <h2 className="text-2xl font-extrabold text-slate-950">AI Insights</h2>
            <p className="mt-1 text-base font-medium text-slate-600">Operational recommendations, risk predictions and model confidence.</p>
          </div>

          <section className="grid gap-6 lg:grid-cols-3">
            <div className="rounded border-2 border-slate-300 bg-white p-6">
              <h3 className="text-lg font-bold text-slate-900">Risk Predictions</h3>
              <p className="mt-2 text-sm text-slate-600">Modelled district-level outbreak probabilities and confidence scores.</p>
            </div>

            <div className="rounded border-2 border-slate-300 bg-white p-6">
              <h3 className="text-lg font-bold text-slate-900">Operational Recommendations</h3>
              <p className="mt-2 text-sm text-slate-600">Recommended prepositioning of resources and interventions.</p>
            </div>

            <div className="rounded border-2 border-slate-300 bg-white p-6">
              <h3 className="text-lg font-bold text-slate-900">Emerging Signals</h3>
              <p className="mt-2 text-sm text-slate-600">Early-warning indicators and anomaly detections from field data.</p>
            </div>
          </section>
        </main>
      </div>
