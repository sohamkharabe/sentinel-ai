    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="min-h-screen">
        ...
        <main className="p-5 lg:p-8">
          <div className="mb-6">
            <h2 className="text-2xl font-extrabold text-slate-950">Reports</h2>
            <p className="mt-1 text-base font-medium text-slate-600">View and export incident, surveillance and district risk reports.</p>
          </div>
          ...
          <section className="grid gap-6 lg:grid-cols-3">
            <div className="rounded border-2 border-slate-300 bg-white p-6">
              ...
              <p className="mt-2 text-sm text-slate-600">Recent community and official incident submissions.</p>
            </div>

            <div className="rounded border-2 border-slate-300 bg-white p-6">
              <h3 className="text-lg font-bold text-slate-900">Disease Surveillance</h3>
              <p className="mt-2 text-sm text-slate-600">Aggregated disease report summaries by district.</p>
            </div>

            <div className="rounded border-2 border-slate-300 bg-white p-6">
              <h3 className="text-lg font-bold text-slate-900">Export / Generate</h3>
              <p className="mt-2 text-sm text-slate-600">Generate CSV or PDF reports for selected districts and date ranges.</p>
            </div>
          </section>
        </main>
      </div>
