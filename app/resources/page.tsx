      ...
      <div className="min-h-screen">
        ...
        <main className="p-5 lg:p-8">
          <div className="mb-6">
            ...
            <p className="mt-1 text-base font-medium text-slate-600">Inventory, pending requests and dispatch status for emergency resources.</p>
          </div>

          <section className="grid gap-6 lg:grid-cols-3">
            <div className="rounded border-2 border-slate-300 bg-white p-6">
              <h3 className="text-lg font-bold text-slate-900">Available Resources</h3>
              <p className="mt-2 text-sm text-slate-600">Current stock of medical kits, water purification, and shelter materials.</p>
            </div>

            <div className="rounded border-2 border-slate-300 bg-white p-6">
              <h3 className="text-lg font-bold text-slate-900">Resources Pending</h3>
              <p className="mt-2 text-sm text-slate-600">Requests awaiting approval or allocation.</p>
            </div>

            <div className="rounded border-2 border-slate-300 bg-white p-6">
              <h3 className="text-lg font-bold text-slate-900">Dispatch Status</h3>
              <p className="mt-2 text-sm text-slate-600">Track ongoing dispatches and ETA to affected districts.</p>
            </div>
          </section>
        </main>
      </div>
